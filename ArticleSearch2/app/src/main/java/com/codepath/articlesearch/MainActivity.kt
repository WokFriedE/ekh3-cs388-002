...
private const val SEARCH_API_KEY = BuildConfig.API_KEY // api key must be in string
...
//        val swipeRefreshLayout = findViewById<SwipeRefreshLayout>(R.id.menu_refresh)
//
