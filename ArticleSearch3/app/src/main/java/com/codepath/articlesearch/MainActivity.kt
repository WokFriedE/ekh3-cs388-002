...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bottomNavigationView.setOnItemSelectedListener { item ->
            ...
            when (item.itemId) {
                R.id.bookFragment -> fragment = bestSellerBooksFragment
                R.id.articleFragment -> fragment = articleListFragment
            }
        ...
        bottomNavigationView.selectedItemId = R.id.bookFragment
    }
